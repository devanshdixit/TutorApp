...
class StudentIntro extends StatefulWidget {
  final String uid;
  StudentIntro({this.uid});
  @override
  _StudentIntroState createState() => _StudentIntroState();
}

class _StudentIntroState extends State<StudentIntro> {
