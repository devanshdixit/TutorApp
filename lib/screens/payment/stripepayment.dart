...
class MysApp extends StatefulWidget {
  @override
  _MysAppState createState() => new _MysAppState();
}

class _MysAppState extends State<MysApp> {
  Token _paymentToken;
  PaymentMethod _paymentMethod;
  String _error;
  String _currentSecret =
      'sk_test_anbJMBykNWwp9ssZHR6vM9N600bWUORpfZ'; //set this yourself, e.g using curl
  ...
  initState() {
    ...
    StripePayment.setOptions(StripeOptions(
      publishableKey: "pk_test_ImNI0ftLXjUkk9R1TOy7g6V600ouEf2zV7",
      merchantId: "Test",
    ));
  }
            ...
            RaisedButton(
              ...
              onPressed: () {
                StripePayment.createSourceWithParams(SourceParams(
                  ...
                  print(source.receiver.toJson());

                  _scaffoldKey.currentState.showSnackBar(
                      SnackBar(content: Text('Received ${source.sourceId}')));
                  setState(() {
                    _currentSecret = source.clientSecret;
                    _source = source;
                  });
                }).catchError(setError);
              },
